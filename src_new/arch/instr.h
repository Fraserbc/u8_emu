...
struct u8_instr {
	void (*handler)(struct u8_arch *, struct u8_oper *, struct u8_oper *);
	uint16_t mask;
...
void instr_brel(struct u8_arch *arch, struct u8_oper *op0, struct u8_oper *op1);	// Bits 8-11 used as immediate operand
